...
<body>
    @if (1 == 1):
        <style>
            .banner {
                background-image: url('/img/pai-campeao2.jpeg');
            ...
            <div class="flash-message">
                @foreach (['danger', 'warning', 'success', 'info'] as $msg)
                    @if (Session::has('flash_' . $msg))
                        ...
                        @endphp
                        <h4>
                            <p class="alert alert-{{ $msg }}">{{ $mensagem }} <a href="#" class="close"
                        ...
                        <div class="col-sm-6 col-xs-12" style="padding:0;text-align:left;">
                            <label>
                                @if (count($promocoes) == 1)
                                    <input type="checkbox" class="minimal" name="promocao[]"
                                        value="{{ $promo->id }}" checked> {{ $promo->nome }}
                                @else
                                    <input type="checkbox" class="minimal" name="promocao[]"
                                        value="{{ $promo->id }}"> {{ $promo->nome }}
                                @endif
                            </label>
                        </div>
                    @endforeach
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Aceite de Termos</h4>
                            </div>
                            <div class="modal-body">
                                <p> Autorizo a rádio Amizade FM armazenar os meus dados, acima informados, até a
                                    finalização da promoção do Dia dos Pais que se encerra em 06/08/2021, conforme Lei
                            ...
                            <div class="modal-footer">
                                ...
                                {!! Form::submit(isset($submitButtonText) ? $submitButtonText : 'Concordo', ['class' => 'btn btn-success']) !!}
                                <input type="hidden" class="" name="ip" id="ip1">
                                {!! Form::close() !!}
                            </div>
                        </div>
                        <!-- /.modal-content -->
            ...
            <div id="novo">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('estado', $estados, 21, ['class' => 'form-control']) !!}
                    </div>
                    <!-- /.input group -->
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('cidade', ['' => 'Selecione um estado'], null, ['class' => 'form-control']) !!}
                    </div>
                    <!-- /.input group -->
                </div>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default pull-left"
                                    data-dismiss="modal">Fechar</button>
                                {!! Form::submit(isset($submitButtonText) ? $submitButtonText : 'Concordo', ['class' => 'btn btn-success']) !!}
                                <input type="hidden" class="" name="ip" id="ip2">
                                {!! Form::close() !!}
                            </div>
                        </div>
                        <!-- /.modal-content -->
    ...
    <div class="footer-pensou">
        <h2>Realização:</h2>
        <a href="http://www.amizade.fm.br/" target="_blank"><img src="/img/logoradiop.png" width="200"></img></a>
    ...
    <div class="footer-pensou-logo">
        ...
        <div class="pensou">
            ...
            <a href="http://www.pensousistemas.com.br" target="_blank"><img src="/img/logopensou.png"
                    width="100"></img></a>
        </div>
    </div>
    <!-- Scripts -->
    ...
    <script>
        function buscaCidades(id, retorno) {
            var op = '<option value="">Carregando...</option>';
            $(retorno).html(op);
            ...
            jQuery.post(
                ...
                function(data) {
                    var options = '<option value="">Selecione cidade</option>';

                    for (var i = 0; i < data.length; i++) {
                        options += '<option value="' + data[i].nom_cidade + '">' + data[i].nom_cidade + '</option>';
                    }
        ...
        $(document).ready(function() {
            ...
            buscaCidades($("#estado").val(), '#cidade');
