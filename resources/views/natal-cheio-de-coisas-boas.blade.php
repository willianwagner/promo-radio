...
<body>
    @if (1 == 1):
        <style>
            .banner {
                background-image: url('/img/natal-cheio-de-coisas-boas.png');
    ...
    <div class="flex-center position-ref full-height">
        <div class="content col-xs-10 col-sm-8">
            ...
            <div id="existente">
                ...
                {!! Form::hidden('tipo', 'natal-cheio-de-coisas-boas') !!}
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p> Autorizo a rádio Amizade FM armazenar os meus dados, acima informados, até a
                                    finalização da promoção, conforme Lei
    ...
    <div class="footer-pensou">
        ...
        <a href="http://www.amizade.fm.br/" target="_blank"><img src="/img/footer.jpg" width="100%"></a>
