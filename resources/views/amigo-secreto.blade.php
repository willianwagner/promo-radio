...
<html lang="{{ app()->getLocale() }}">
  ...
  <![endif]-->
    ...
    <body>
      ...
      <style>
        .banner{
          background-image: url('/img/amigo-secreto.jpg');
        ...
        <div class="flex-center position-ref full-height">
            <div class="content col-xs-10 col-sm-8">
              ...
              <p>
                ...
                {!! Form::hidden('tipo', 'amigo-secreto') !!}
				   <div class="form-group">
                   @if (\Session::has('cpf'))
                    {!! Form::hidden('cpf', \Session::get('cpf'), ['class' => 'form-control']) !!}
                   @else
                   <style>
                    .plus{display:none;}
                   </style>
                ...
                <h4>
                  <p class="alert alert-info">Você pode selecionar até dois presentes dessa promoção!</p>
                </h4>
                 @foreach($promocoes as $promo)
                  <div class="col-sm-6 col-xs-12" style="padding:0;text-align:left;">
                    <div class="col-xs-12">
                      <img style="width:100%;" src="/uploads/promocoes/{{$promo->imagem}}"/>
                    </div>
                    <div class="col-xs-12">
                    <label>
                      @if(count($promo) == 1)
                        <input type="checkbox" class="check minimal" name="promocao[]" value="{{$promo->id}}"> {{$promo->nome}}
                      @else
                        <input type="checkbox" class="check minimal" name="promocao[]" value="{{$promo->id}}"> {{$promo->nome}}
                      @endif
                    </label>
                ...
                <h4>
                 ...
                 @foreach($promocoes as $promo)
                  ...
                  <label>
                    ...
                    @if($tem == 1)
                      <input type="checkbox" class="minimal check" name="promocao[]" value="{{$promo->id}}" checked> {{$promo->nome}}
                    @else
                      <input type="checkbox" class="minimal check" name="promocao[]" value="{{$promo->id}}"> {{$promo->nome}}
                    @endif
                  </label>
                </div>
                </div>
