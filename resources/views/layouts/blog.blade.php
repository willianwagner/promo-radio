...
<div class="page-container">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 sidebar">
                        <div class="bg-color-gray widget px-40px">
                            <div class="pt-40px pb-50px">
                                ...
                                <ul class="category-list list-unstyled">
                                    <li>
                                        <a href="/categoria-blog/Notícias">
                                            Notícias
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/categoria-blog/Eventos">
                                            Eventos
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/categoria-blog/Social">
                                            Social
                                        </a>
                                    </li>
                                    <li>
                                        <a href="/categoria-blog/Esporte">
                                            Esporte
                                        </a>
                                    </li>
                                    <li>
                        ...
                        <div class="widget">
                            <form role="search" class="search-form" action="/pesquisa-blog">
                        ...
                        <div class="widget bg-color-gray px-30px">
                            <h5 class="widget-title pt-40px ">Mais Acessadas</h5>
                            <div class="mb-50px">
                                <div class="pb-50px">
    ...
    <script type="text/javascript" src="/site/js/main.js"></script>
        ...
        <script>
            ...
            jQuery.get( "/top-posts", function( data ) {
                html = '<ul class="list-unstyled post-simple-list">';


                $.each(data.top_posts,function(){
                    contador++;

                    html += '<li class="media">';
                    html += '<span class="reveal-title mr-3">'+contador+'</span>';
                    html += '<div class="media-body">';
                    html += '<a href="/blog/'+this.id+'">'+this.titulo+'</a>';
                    html += '</div>';
                    html += '</li>';
                });
